...
# data_files_year = ['11.csv', '12.csv', '13.csv', '14.csv', '15.csv', '16.csv', '17.csv', '18.csv', '19.csv']
# penultimate_data_file_name = data_files[0] + data_files_year[0]
# print(penultimate_data_file_name)
# final_data_file_name = os.path.join(data_file_path_year, penultimate_data_file_name)
# print(final_data_file_name)
# data_f = pd.read_csv(data_file_path / data_files[1], delimiter=',', names=['sno','welltype','district','prev_year',
#                                                        'cur_year',
#                                                        'rise','fall','remarks'])
...
for i in range(12):
    ...
    try:
        with open(final_data_file_name, 'r') as f:
            pass
    ...
    data_f = pd.read_csv(final_data_file_name, delimiter=',',
                          names=['sno', 'welltype', 'district', 'prev_year',
                                 'cur_year',
                                 'rise', 'fall', 'remarks'])
    ...
    image_name = final_data_file_name + '.png'
    plt.savefig(final_images_path / image_name)
